...
CREATE TABLE IF NOT EXISTS realtime_subway_positions (
    ...
    last_rec_date VARCHAR(20),             -- lastRecptnDt: 최종 수신 날짜 (YYYYMMDD)
    last_rec_time VARCHAR(20),             -- recptnDt: 최종 수신 시간 (YYYY-MM-DD HH:MM:SS)
...
-- 인덱스 생성 (조회 성능 최적화)
CREATE INDEX IF NOT EXISTS idx_line_id ON realtime_subway_positions(line_id);
